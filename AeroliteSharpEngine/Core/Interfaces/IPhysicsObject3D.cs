...
namespace AeroliteSharpEngine.Core.Interfaces
{
    ...
    /// </summary>
    public interface IPhysicsObject3D : IEquatable<IPhysicsObject3D>
    {
        /// <summary>
